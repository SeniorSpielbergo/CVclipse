...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.mbse.cvclipse.CV} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CVItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CV_picture_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CV_picture_feature", "_UI_CV_type"),
				 CvclipsePackage.Literals.CV__PICTURE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CvclipsePackage.Literals.CV__BLOCKS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(CvclipsePackage.Literals.CV__BLOCKS,
				 CvclipseFactory.eINSTANCE.createItemBlock()));
