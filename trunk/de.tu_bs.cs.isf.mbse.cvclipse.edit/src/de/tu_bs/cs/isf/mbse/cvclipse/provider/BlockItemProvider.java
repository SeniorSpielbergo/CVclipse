...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.mbse.cvclipse.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CvclipsePackage.Literals.BLOCK__ITEMS);
			childrenFeatures.add(CvclipsePackage.Literals.BLOCK__TITLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CvclipsePackage.Literals.BLOCK__ITEMS,
				 CvclipseFactory.eINSTANCE.createDateItem()));

		newChildDescriptors.add
			(createChildParameter
				(CvclipsePackage.Literals.BLOCK__ITEMS,
				 CvclipseFactory.eINSTANCE.createTextItem()));

		newChildDescriptors.add
			(createChildParameter
				(CvclipsePackage.Literals.BLOCK__TITLE,
