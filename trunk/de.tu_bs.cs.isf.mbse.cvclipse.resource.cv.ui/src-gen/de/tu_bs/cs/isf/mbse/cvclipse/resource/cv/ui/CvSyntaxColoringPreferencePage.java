 ...
 */
public class CvSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public CvSyntaxColoringPreferencePage() {
		super();
		
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation metaInformation = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPixelConverter pixelConverter = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor) {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor emfTextEditor = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor) editor;
