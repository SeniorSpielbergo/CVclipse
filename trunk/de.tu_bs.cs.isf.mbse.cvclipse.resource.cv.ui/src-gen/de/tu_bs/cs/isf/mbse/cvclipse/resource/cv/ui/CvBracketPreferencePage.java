 ...
 * </ul>
 */
public class CvBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getSyntaxName();
	
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public CvBracketPreferencePage() {
		super();
		
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvMetaInformation metaInformation = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor) {
			((de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor) editor).invalidateTextRepresentation();
		}
	}
