 ...
 */
public class CvIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
