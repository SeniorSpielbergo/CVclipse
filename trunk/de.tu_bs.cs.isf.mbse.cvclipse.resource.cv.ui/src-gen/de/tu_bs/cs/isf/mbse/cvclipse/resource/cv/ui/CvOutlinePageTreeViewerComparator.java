...
public class CvOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvNameProvider nameProvider = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().createNameProvider();
