...
public class CvNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public CvNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getSyntaxName();
	}
