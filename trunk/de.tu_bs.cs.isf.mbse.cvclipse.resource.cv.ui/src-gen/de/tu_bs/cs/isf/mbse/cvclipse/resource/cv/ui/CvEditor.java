...
/**
 * A text editor for 'cv' models.
 * <p>
 * This editor has id
 * <code>de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor</code>
 * The editor's context menu has id
 * <code>de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.EditorRuler</code>.
 * </p>
 */
public class CvEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvResourceProvider, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.ICvBracketHandlerProvider, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.ICvAnnotationModelProvider {
	
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvCodeFoldingManager codeFoldingManager;
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBackgroundParsingStrategy bgParsingStrategy = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBackgroundParsingStrategy();
	private java.util.Collection<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBackgroundParsingListener>();
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvColorManager colorManager = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvColorManager();
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvOutlinePage outlinePage;
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPropertySheetPage propertySheetPage;
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.ICvBracketHandler bracketHandler;
	...
	public CvEditor() {
		super();
		setSourceViewerConfiguration(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), CvEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource currentResource = getResource();
				...
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.EditorContext");
		setRulerContextMenuId("de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvNature.activate(inputFile.getProject());
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource loadedResource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) {
					setResource((de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the CvEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource textResource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) element.eResource();
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextToken token = lexer.getNextToken();
			...
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!CvEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.ICvBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.ICvBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource)) {
					return false;
				}
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource textResource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) resource;
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
