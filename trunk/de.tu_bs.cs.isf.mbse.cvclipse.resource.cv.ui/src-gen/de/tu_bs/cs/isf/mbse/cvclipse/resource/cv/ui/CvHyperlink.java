 ...
 */
public class CvHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public CvHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
