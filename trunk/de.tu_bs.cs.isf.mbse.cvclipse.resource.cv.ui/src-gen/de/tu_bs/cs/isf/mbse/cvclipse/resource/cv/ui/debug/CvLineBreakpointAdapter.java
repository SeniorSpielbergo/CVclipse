...
public class CvLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvPlugin.DEBUG_MODEL_ID);
			...
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvLineBreakpoint lineBreakpoint = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvLineBreakpoint(resource, lineNumber + 1);
