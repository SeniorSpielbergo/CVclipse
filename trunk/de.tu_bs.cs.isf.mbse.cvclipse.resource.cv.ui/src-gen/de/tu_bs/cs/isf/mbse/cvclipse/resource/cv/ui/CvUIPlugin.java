 ...
 */
public class CvUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui";
	public static final String EDITOR_ID = "de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor";
	...
	private static CvUIPlugin plugin;
	...
	public static CvUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CvUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CvUIPlugin.PLUGIN_ID, message);
		}
		final CvUIPlugin pluginInstance = CvUIPlugin.getDefault();
