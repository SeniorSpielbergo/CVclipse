 ...
 */
public class CvNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui");
							...
							String natureID = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvNature.NATURE_ID;
							...
							for (String builderID : de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation info = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.getDefault().getBundle();
