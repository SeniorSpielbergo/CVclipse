 ...
 * hovers, is a proxy.
 */
public class CvHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public CvHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
