 ...
 * 
 */
package de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.debug;

@SuppressWarnings("restriction")
public class CvAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getSyntaxName())) {
					return new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.debug.CvLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugVariable) {
			final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugVariable variable = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugVariable) {
			final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugVariable variable = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugValue castedValue = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugValue) value;
