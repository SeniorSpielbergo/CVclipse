 ...
 */
public class CvBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource resource, final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource resource, final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource resource, final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource) {
							de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource concreteResource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource) resource;
