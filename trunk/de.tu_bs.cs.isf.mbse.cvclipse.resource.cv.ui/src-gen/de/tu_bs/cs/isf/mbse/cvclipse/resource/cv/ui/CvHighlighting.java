 ...
 */
public class CvHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPositionHelper positionHelper = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPositionHelper();
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvTokenScanner scanner;
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvOccurrence occurrence;
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public CvHighlighting(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvColorManager colorManager, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvTokenScanner(textResource, colorManager);
		occurrence = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
