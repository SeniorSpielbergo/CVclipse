 ...
 */
public class CvLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.launch.CvLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvPlugin.logError("Exception while launching selection", e);
		}
	}
