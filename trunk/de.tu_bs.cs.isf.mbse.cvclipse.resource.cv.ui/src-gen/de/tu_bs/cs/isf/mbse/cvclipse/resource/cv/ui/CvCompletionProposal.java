 ...
 */
public class CvCompletionProposal implements java.lang.Comparable<CvCompletionProposal> {
	 ...
	 */
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvExpectedTerminal expectedTerminal;
	...
	public CvCompletionProposal(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public CvCompletionProposal(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
	...
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof CvCompletionProposal) {
			CvCompletionProposal other = (CvCompletionProposal) object;
	...
	public int compareTo(CvCompletionProposal object) {
		if (object instanceof CvCompletionProposal) {
			CvCompletionProposal other = (CvCompletionProposal) object;
