 ...
 * @since 3.2
 */
public class CvBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput fInput;
	 ...
	 */
	public CvBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public CvBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public CvBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput);
		...
		fInput= (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput) input;
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput getInput() {
		return fInput;
	}
