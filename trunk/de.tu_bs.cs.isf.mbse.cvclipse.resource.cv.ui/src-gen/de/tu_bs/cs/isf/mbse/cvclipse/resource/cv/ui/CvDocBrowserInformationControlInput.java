 ...
 * olInput</code>.
 */
public class CvDocBrowserInformationControlInput {
	
	private final CvDocBrowserInformationControlInput fPrevious;
	private CvDocBrowserInformationControlInput fNext;
	 ...
	 */
	public CvDocBrowserInformationControlInput(CvDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public CvDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public CvDocBrowserInformationControlInput getNext() {
		return fNext;
	}
