 ...
 * a specified depth.
 */
public class CvOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public CvOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvPlugin.logError("Exception while refreshing outline view", e);
		}
	}
