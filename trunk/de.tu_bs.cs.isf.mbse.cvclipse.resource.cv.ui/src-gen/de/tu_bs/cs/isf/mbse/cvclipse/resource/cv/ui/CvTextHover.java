 ...
 */
public class CvTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	
	private static final String FONT = org.eclipse.jface.resource.JFaceResources.DIALOG_FONT;
	
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvResourceProvider resourceProvider;
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput infoInput = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHyperlink hyperlink = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBrowserInformationControl iControl = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput) {
							de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput input = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBrowserInformationControl.isAvailable(parent)) {
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBrowserInformationControl iControl = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public CvTextHover(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHTMLPrinter.insertPageProlog(buffer, 0, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvTextHover.getStyleSheet());
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHTMLPrinter.addPageEpilog(buffer);
			return new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStreamUtil.getContent(styleSheetURL.openStream());
