...
public class CvBracketSet {
	...
	private java.util.ArrayList<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair {
	 ...
	 */
	private class ClosingListener implements de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.ICvBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public CvBracketSet(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair>();
	 ...
	 */
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair getBracketPair(String opening, String closing) {
		for (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair bracketPair : bracketPairs) {
	...
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair remove(String opening, String closing) {
		for (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
