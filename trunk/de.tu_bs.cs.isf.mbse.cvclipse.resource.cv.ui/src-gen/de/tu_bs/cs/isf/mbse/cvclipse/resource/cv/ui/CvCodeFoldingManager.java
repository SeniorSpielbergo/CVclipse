 ...
 */
public class CvCodeFoldingManager {
	
	private class FoldingUpdateListener implements de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor) {
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor) workbenchPart;
	...
	protected de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor;
	 ...
	 */
	public CvCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor textEditor) {
	...
	private void addCloseListener(final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ui.CvUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource textResource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
