 ...
 */
public class CvNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public CvNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new cv file");
