...
/**
 * CvLayoutInformation objects are used to store layout information that is found
 ...
 * CvLayoutInformations are aggregated in LayoutInformationAdapters. One
 * CvLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class CvLayoutInformation {
	 ...
	 */
	private final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvSyntaxElement syntaxElement;
	...
	public CvLayoutInformation(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvSyntaxElement getSyntaxElement() {
