...
public class CvLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvSyntaxElement syntaxElement = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvPlaceholder) {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvPlaceholder placeholder = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvPlaceholder) syntaxElement;
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTokenResolver tokenResolver = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTokenResolveResult result = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
