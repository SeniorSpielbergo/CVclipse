...
/**
 * A CvLayoutInformationAdapter is used to store layout information that is found
 ...
 * CvLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class CvLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation> layoutInformations = new java.util.ArrayList<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation>();
	...
	public java.util.List<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvLayoutInformation layoutInformation) {
