...
public class CvRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
