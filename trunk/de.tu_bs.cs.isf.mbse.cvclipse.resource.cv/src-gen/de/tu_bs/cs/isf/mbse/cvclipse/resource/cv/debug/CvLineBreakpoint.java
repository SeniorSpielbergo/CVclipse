...
public class CvLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.lineBreakpoint.marker";
	
	public CvLineBreakpoint() {
		super();
	}
	
	public CvLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugTarget target) {
		try {
	...
	public void remove(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
