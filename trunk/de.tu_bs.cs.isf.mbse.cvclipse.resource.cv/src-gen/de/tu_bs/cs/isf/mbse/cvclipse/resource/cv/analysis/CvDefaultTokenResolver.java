 ...
 */
public class CvDefaultTokenResolver implements de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTokenResolver {
	 ...
	 */
	public CvDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvGrammarInformationProvider.INSTANCE.getKeywords()) {
