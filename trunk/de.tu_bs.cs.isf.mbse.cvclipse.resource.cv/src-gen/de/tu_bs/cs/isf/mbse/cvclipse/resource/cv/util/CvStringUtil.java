...
public class CvStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvFunction1<String, T> toStringFunction) {
