 ...
 * given name.
 */
public class CvReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvReferenceCache {
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvNameProvider nameProvider;
	
	public CvReferenceCache(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvNameProvider nameProvider) {
		super();
