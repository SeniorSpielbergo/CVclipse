 ...
 * contains
 * <code>de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class CvMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<Object>> commands = new java.util.ArrayList<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<Object>> commandsToProcess = new java.util.ArrayList<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextDiagnostic diagnostic) {
		final de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvProblem problem = diagnostic.getProblem();
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.CvEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.CvEProblemSeverity.ERROR) {
					...
					de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextDiagnostic textDiagnostic = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.CvEProblemType nextType : de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.CvEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.CvEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.CvEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.CvEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
