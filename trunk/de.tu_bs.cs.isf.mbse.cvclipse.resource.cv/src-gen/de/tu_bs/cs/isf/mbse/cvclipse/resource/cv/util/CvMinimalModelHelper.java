 ...
 */
public class CvMinimalModelHelper {
	
	private final static de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvEClassUtil eClassUtil = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvListUtil.castListUnchecked(value);
