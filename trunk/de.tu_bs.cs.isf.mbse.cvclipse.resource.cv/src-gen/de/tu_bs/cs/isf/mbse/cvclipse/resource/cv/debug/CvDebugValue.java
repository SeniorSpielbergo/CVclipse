...
public class CvDebugValue extends de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public CvDebugValue(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
