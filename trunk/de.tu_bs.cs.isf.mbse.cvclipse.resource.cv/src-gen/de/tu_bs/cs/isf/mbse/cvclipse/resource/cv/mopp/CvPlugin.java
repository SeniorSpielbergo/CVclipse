 ...
 */
public class CvPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "de.tu_bs.cs.isf.mbse.cvclipse.resource.cv";
	/**
	...
	private static CvPlugin plugin;
	...
	public static CvPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, CvPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, CvPlugin.PLUGIN_ID, message);
		}
		final CvPlugin pluginInstance = CvPlugin.getDefault();
