 ...
 * to 4 bytes).
 */
public class CvUnicodeConverter extends de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvInputStreamProcessor {
	 ...
	 */
	public CvUnicodeConverter(java.io.InputStream inputStream) {
