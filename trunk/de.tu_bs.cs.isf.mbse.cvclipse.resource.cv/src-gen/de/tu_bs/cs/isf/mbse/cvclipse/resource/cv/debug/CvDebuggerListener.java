 ...
 * code).
 */
public class CvDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.AbstractCvDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvPair<String, Object>>();
	...
	public CvDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStringUtil.encode('#', stack);
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage message = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage message = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.GET_VARIABLES)) {
				...
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage message = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvPair<String, Object> pair = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvPair<String, Object>(name, value);
	...
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.AbstractCvDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.AbstractCvDebuggable debuggable) {
