...
public class CvBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.builder";
	
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBuilder defaultBuilder = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource customResource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource) resourceSet.getResource(uri, true);
			new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMarkerHelper().getMarkerID(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.CvEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvTaskItemBuilder taskItemBuilder = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvTaskItemBuilder();
		new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getSyntaxName())) {
