...
public class CvStackFrame extends de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugTarget target;
	private String name;
	private int id;
	...
	public CvStackFrame(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStringUtil.decode(data, ',');
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvStackFrame other = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvStackFrame) obj;
		if (name == null) {
