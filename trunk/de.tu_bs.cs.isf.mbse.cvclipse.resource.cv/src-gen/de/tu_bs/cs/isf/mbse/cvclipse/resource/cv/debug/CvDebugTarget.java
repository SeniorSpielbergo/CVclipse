...
public class CvDebugTarget extends de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugElement implements org.eclipse.debug.core.model.IDebugTarget, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ICvDebugEventListener {
	
	/**
	 * associated system process
	 */
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugProcess process;
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ICvDebugEventListener> eventListeners = new java.util.ArrayList<de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ICvDebugEventListener>();
	
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ICvDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public CvDebugTarget(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ICvDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ICvDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvLineBreakpoint lineBreakpoint = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvLineBreakpoint) breakpoint;
	...
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.CvDebugProxy getDebugProxy() {
