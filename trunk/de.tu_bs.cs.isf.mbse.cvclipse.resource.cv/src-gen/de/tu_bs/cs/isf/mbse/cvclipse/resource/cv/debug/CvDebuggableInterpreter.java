 ...
 */
public class CvDebuggableInterpreter<ResultType, ContextType> extends de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.AbstractCvDebuggable {
	
	/**
	 * The actual interpreter. Interpretation is delegated to this object.
	 */
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.AbstractCvInterpreter<ResultType, ContextType> interpreterDelegate;
	
	/**
	 * To check whether we must stop the execution after step over/into/return, we use
	 * a closure
	 */
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<org.eclipse.emf.ecore.EObject> stopCondition;
	...
	public CvDebuggableInterpreter(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.AbstractCvInterpreter<ResultType, ContextType> interpreterDelegate, int eventPort) {
		this.eventPort = eventPort;
		this.interpreterDelegate = interpreterDelegate;
		this.interpreterDelegate.addListener(new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvInterpreterListener() {
	...
	public String[] getStack() {
		...
		for (org.eclipse.emf.ecore.EObject parent : parents) {
			String serializedStackElement = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvStringUtil.encode(',', new String[] {parent.eClass().getName(), Integer.toString(stackFrameID), parent.eResource().getURI().toString(), Integer.toString(getLine(parent)), Integer.toString(getCharStart(parent)), Integer.toString(getCharEnd(parent))});
	...
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.AbstractCvInterpreter<ResultType, ContextType> getInterpreterDelegate() {
		return interpreterDelegate;
	}
	
	private int getLine(org.eclipse.emf.ecore.EObject element) {
		int line = -1;
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvLocationMap locationMap = getLocationMap(element);
		if (locationMap != null) {
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvLocationMap getLocationMap(org.eclipse.emf.ecore.EObject element) {
	...
	private void evaluateStep(org.eclipse.emf.ecore.EObject element) {
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<org.eclipse.emf.ecore.EObject> stopCheck = stopCondition;
		if (stopCheck != null && stopCheck.execute(element)) {
			stopCondition = null;
			// suspending after step...
			setSuspend(true);
			sendEvent(de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.debug.ECvDebugMessageTypes.SUSPENDED, true);
			return;
		}
		waitIfSuspended();
	}
	...
	public void stepOver() {
		...
		final int currentLevel = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvEObjectUtil.getDepth(current);
		stopCondition = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
				...
				int depth = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvEObjectUtil.getDepth(element);
	...
	public void stepReturn() {
		...
		final int parentLevel = de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvEObjectUtil.getDepth(current) - 1;
		stopCondition = new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
