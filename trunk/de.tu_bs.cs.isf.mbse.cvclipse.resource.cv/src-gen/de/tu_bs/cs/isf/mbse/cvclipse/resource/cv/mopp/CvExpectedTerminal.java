 ...
 */
public class CvExpectedTerminal {
	...
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvContainmentTrace containmentTrace;
	
	public CvExpectedTerminal(org.eclipse.emf.ecore.EObject container, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvExpectedElement terminal, int followSetID, de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvContainmentTrace containmentTrace) {
		super();
	...
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		CvExpectedTerminal otherExpectedTerminal = (CvExpectedTerminal) o;
	...
	public de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.grammar.CvContainmentTrace getContainmentTrace() {
