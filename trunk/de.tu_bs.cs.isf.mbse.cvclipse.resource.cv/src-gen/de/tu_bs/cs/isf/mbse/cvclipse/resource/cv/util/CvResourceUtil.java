...
public class CvResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.util.CvInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource getResource(java.io.File file) {
	...
	public static de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.mopp.CvResource) resource;
	}
	 ...
	 */
	public static de.tu_bs.cs.isf.mbse.cvclipse.Application getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static de.tu_bs.cs.isf.mbse.cvclipse.Application getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (de.tu_bs.cs.isf.mbse.cvclipse.Application) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static de.tu_bs.cs.isf.mbse.cvclipse.Application getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource resource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		de.tu_bs.cs.isf.mbse.cvclipse.resource.cv.ICvTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
